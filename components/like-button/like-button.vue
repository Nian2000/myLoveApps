	...
	export default {
		props: {
			...
			showImgs: { // 显示图标路径
				...
				default: () => {
					return [
						'/static/heart/h (1).png',
						'/static/heart/h (2).png',
						'/static/heart/h (3).png',
						'/static/heart/h (4).png',
						'/static/heart/h (6).png',
						'/static/heart/h (7).png',
						'/static/heart/h (8).png',
						'/static/heart/h (9).png',
						'/static/heart/a1.png',
						'/static/heart/a2.png',
						'/static/heart/a3.png',
						'/static/heart/a4.png'
